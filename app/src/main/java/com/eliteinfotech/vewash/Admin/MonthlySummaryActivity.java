...
public class MonthlySummaryActivity extends AppCompatActivity {
    ...
    ArrayList<SummaryInfo> summarize() {
        ...
        for (int i = 0; i < orderLst.size(); i++) {
            if (!dlist.contains(DateUtils.convertToString(orderLst.get(i).getCreatedDate(), "MMMM")))
    ...
    String getCount(String date) {
        ...
        dl.clear();
        for (int i = 0; i < orderLst.size(); i++) {
            if (DateUtils.convertToString(orderLst.get(i).getCreatedDate(), "MMMM").equals(date))
