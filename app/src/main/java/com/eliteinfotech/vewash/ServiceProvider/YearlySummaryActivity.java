...
public class YearlySummaryActivity extends AppCompatActivity {
    ...
    ArrayList<SummaryInfo> summarize() {
        ...
        for (int i = 0; i < orderLst.size(); i++) {
            if (orderLst.get(i).getServiceProviderID().equals(loginPref.getString("userid")) && !dlist.contains(DateUtils.convertToString(orderLst.get(i).getCreatedDate(), "yyyy")))
    ...
    String getCount(String date) {
        ...
        dl.clear();
        for (int i = 0; i < orderLst.size(); i++) {
            if (orderLst.get(i).getServiceProviderID().equals(loginPref.getString("userid")) && DateUtils.convertToString(orderLst.get(i).getCreatedDate(), "yyyy").equals(date))
